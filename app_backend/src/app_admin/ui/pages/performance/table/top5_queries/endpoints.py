...
from app_admin.ui.pages.performance.table.top5_queries.schema import QueryStatEntry
...
top5_queries_router = APIRouter()

@top5_queries_router.get("/", response_model=List[QueryStatEntry])

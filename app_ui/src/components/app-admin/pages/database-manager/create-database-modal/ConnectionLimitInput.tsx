    ...
    <div className="space-y-3">
      ...
      <div className="flex gap-2">
        <button
          ...
          className={`px-3 py-1.5 text-sm rounded-md border transition-colors ${mode === 'preset'
        ...
        <button
          ...
          className={`px-3 py-1.5 text-sm rounded-md border transition-colors ${mode === 'custom'
            ? 'bg-lime-50 border-lime-300 text-lime-700'
            : 'bg-white border-slate-300 text-slate-600 hover:bg-slate-50'
            }`}
        >

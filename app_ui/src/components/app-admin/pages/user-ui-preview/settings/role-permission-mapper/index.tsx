...
import type { RoleConfiguration, CustomRole, RLSRule, Role } from './types';
            ...
            <div className="space-y-2">
                {allRoles.map((role) => {
                    ...
                    return (
                        <Card
                            key={roleId}
                            className={`border-2 transition-all ${isSelected ? 'border-violet-400 bg-violet-50/50' : 'border-slate-200'
                                }`}
                        >
